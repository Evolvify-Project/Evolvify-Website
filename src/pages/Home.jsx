    ...
    <main className="bg-white text-darkBlue2">
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          <div className="text-center md:text-left md:w-1/2 space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              GROW UP <span className="text-blue-500">YOUR</span>
              <br />
              SKILL IN MINUTES
            </h1>
            <Link to="./Quiz">
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-center md:text-left space-y-4">
            ...
            <p className="text-base leading-relaxed">
              We are a dedicated team of experts passionate about personal
              development, communication, leadership, and emotional
              intelligence. We provide valuable resources, training, and
              insights to help individuals unlock their full potential.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20" data-aos="fade-left">
        <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center gap-8">
          <div className="md:w-1/2 text-center md:text-left space-y-4">
            ...
            <p className="text-base leading-relaxed">
              Unlock your full potential by developing essential soft skills
              that drive success in both your personal and professional life. We
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="lg:w-1/2 space-y-3 text-center lg:text-left ">
            ...
            <p className="text-base">
              At <span className="text-[#6EC1E4] font-medium">Evolvify</span>,
              we empower you with essential soft skills to excel in your
              personal and professional life. Here’s why we’re your best choice:
            </p>
      ...
      <section className="py-20" data-aos="fade-up">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-darkBlue2 mb-10">
            Available skills
          </h2>
      ...
      <section className="py-20 bg-[#F9FBFC] text-center" data-aos="fade-up">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-darkBlue2 mb-6">
            Download our app now!
          </h2>
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-10">
            <a
              href="#"
              className="bg-[#2769A2] text-white py-2 px-6 rounded-full text-sm hover:bg-darkBlue2 transition"
            >
